...
const srcBoardId = config.boards.web.source.board_id;
const srcLaneToMoveTo = config.boards.web.source.lane_tomove;
const srcLaneId = config.boards.web.source.lane_id;
const srcBoardUrl = baseURL + "/io/board/" + srcBoardId + "/card?lanes=" + srcLaneId;
const deploymentTechReviewCoSId = config.boards.web.source.techreview_cos;

const targetBoardId = config.boards.web.target.board_id;
const targetLaneId = config.boards.web.target.lane_id; 
const targetTechReviewClassofServiceID = config.boards.web.target.techreview_cos;
const targetCardTypeId = config.boards.web.target.cardtype_id;
...
module.exports = robot => {
	console.log( "DarthBot Web Board Monitor initializing...." );
	monitorCard();
